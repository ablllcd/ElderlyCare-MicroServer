package com.elderlycare.service.medicineManagement;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.elderlycare.mapper.medicineManagement.IntakeMapper;
import com.elderlycare.mapper.medicineManagement.MedicineMapper;
...
public class UserMedicalService {
    ...
    public void addMedicine(UserDetails userDetails, MultiTimeMedicineRequest medicineRequest){
        // 获取用户ID
    ...
    public List<MultiTimeMedicineRequest> getAllMedicine(UserDetails userDetails){
        // 获取用户ID
        Account account = (Account) userDetails;
        Integer userID = account.getId();
    ...
    public void deleteMedicineWithMultiTime(UserDetails userDetails, MultiTimeMedicineRequest multiTimeMedicineRequest){
        // 获取用户ID
        Account account = (Account) userDetails;
        Integer userID = account.getId();
    ...
    public void deleteSingleMedicineTime(UserDetails userDetails, Medicine medicine){
        // 获取用户ID
        Account account = (Account) userDetails;
        Integer userID = account.getId();
    ...
    public void addMedicineIntake(UserDetails userDetails, MedicineIntake medicineIntake){
        // 获取用户ID
        Account account = (Account) userDetails;
        Integer userID = account.getId();
    ...
    public ArrayList<MedicineIntake> getMedicineIntakeByTime(UserDetails userDetails, String currentDate){
        // 获取用户ID
        Account account = (Account) userDetails;
        Integer userID = account.getId();
